    ...
    <>
      ...
      <div className="mt-4 space-y-4 sm:mt-6 sm:space-y-6">
        <div className="space-y-3">
          <div>
            <Link
              to={paths.auth.google.getHref(redirectTo)}
          ...
          <div>
            <Link
              to={paths.auth.apple.getHref(redirectTo)}
              className="mb-2 mr-2 inline-flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-gray-900 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
            >
              <svg
          ...
          {({ register, formState }) => (
            <>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-start">
                  <div className="flex h-5 items-center">
                    <input
                      ...
                      type="checkbox"
                      className="focus:ring-3 h-4 w-4 rounded-sm border border-gray-300 bg-gray-50 focus:ring-primary-300 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"
                      required={false}
                    />
                  </div>
                ...
                <Link
                  to={paths.auth.forgotPassword.getHref(redirectTo)}
