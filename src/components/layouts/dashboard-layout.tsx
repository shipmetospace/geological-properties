...
export function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900">
            ...
            <div className="flex h-full flex-col justify-between py-2">
              <div>
                ...
                <SidebarItems className="pb-32">
                  <SidebarItemGroup>
                    <SidebarItem to="#" icon={HiChartPie}>
                      Overview
                    </SidebarItem>
                    <SidebarCollapse icon={HiDocument} label="Pages">
                      <SidebarItem to="#">Settings</SidebarItem>
                      <SidebarItem to="#">Kanban</SidebarItem>
                      <SidebarItem to="#">Calendar</SidebarItem>
                    </SidebarCollapse>
                    <SidebarCollapse icon={HiShoppingBag} label="Sales">
                      <SidebarItem to="#">Products</SidebarItem>
                      <SidebarItem to="#">Billing</SidebarItem>
                      <SidebarItem to="#">Invoice</SidebarItem>
                    </SidebarCollapse>
                    <SidebarItem
                      to="#"
                    ...
                    <SidebarCollapse icon={HiLockClosed} label="Authentication">
                      <SidebarItem to="#">Sign In</SidebarItem>
                      <SidebarItem to="#">Sign Up</SidebarItem>
                      <SidebarItem to="#">Forgot Password</SidebarItem>
                    </SidebarCollapse>
                  </SidebarItemGroup>
                  <SidebarItemGroup>
                    <SidebarItem to="#" icon={HiClipboard}>
                      Docs
                    </SidebarItem>
                    <SidebarItem to="#" icon={HiCollection}>
                      Components
                    </SidebarItem>
                    <SidebarItem to="#" icon={HiInformationCircle}>
                      Help
                    </SidebarItem>
                  </SidebarItemGroup>
                </SidebarItems>
      ...
      >
        <SidebarItemGroup>
          <SidebarItem to="#" icon={HiCalendar} label="Calendar">
            Calendar
          </SidebarItem>
          <SidebarItem to="#" icon={HiLightBulb} label="Notes">
            Notes
          </SidebarItem>
          <SidebarItem to="#" icon={HiClipboardCheck} label="To-do list">
            To-do list
          </SidebarItem>
          <SidebarItem to="#" icon={HiUsers} label="Users">
            Users
          </SidebarItem>
          <SidebarItem to="#" icon={HiVideoCamera} label="Media">
            Media
          </SidebarItem>
        </SidebarItemGroup>
        <SidebarItemGroup>
          <SidebarItem to="#" icon={HiPresentationChartBar} label="Statistics">
            Statistics
          </SidebarItem>
          <SidebarItem to="#" icon={HiLocationMarker} label="Locations">
            Locations
          </SidebarItem>
          <SidebarItem to="#" icon={HiPlus} label="New item">
            New item
          </SidebarItem>
        </SidebarItemGroup>
      </Sidebar>
